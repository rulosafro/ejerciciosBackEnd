...
const { getCarts, getCartsById, createCarts, updateCarts, deleteCart, deleteProductOnCart, putProductOnCarts, getMyCart, putProductOnMyCart, } = require("../controllers/carts.controller")
...
router.post("/:cid/product/:pid/quantity/:num", putProductOnCarts)
