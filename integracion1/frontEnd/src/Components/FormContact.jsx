export const FormContact = () => {
  return (
    <section className="container mx-auto md:px-6 my-10">
      <div className="relative h-[300px] rounded-lg overflow-hidden bg-cover bg-[50%] bg-no-repeat bg-[url('https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/images/every-type-of-watch-you-need-lead-1612212900.jpg?crop=1.00xw:0.896xh;0,0.0520xh&resize=1200:*')]"></div>
      <div className="container px-6 md:px-12">
        <div
          className="block rounded-lg  px-6 py-12 shadow-xl md:py-16 md:px-12 -mt-[100px] backdrop-blur-lg">
            ...
            <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:px-3 lg:mb-0 lg:w-5/12 lg:px-6">
              ...
              <form>
                ...
                <button type="button" data-te-ripple-init data-te-ripple-color="light"
                  className="mb-6 inline-block w-full rounded bg-primary px-6 pt-2.5 pb-2 text-xs font-medium uppercase leading-normal text-white text-bold shadow-[0_4px_9px_-4px_#3b71ca] transition duration-150 ease-in-out hover:bg-primary-600 hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:bg-primary-600 focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:outline-none focus:ring-0 active:bg-primary-700 active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] lg:mb-0">
                Send
                </button>
              </form>
            </div>
